  ...
  return (
    <div className='flex flex-col gap-4 items-center justify-center bg-creamy text-dark-green pt-10 pb-20 px-10'>
      ...
      <div className='relative flex flex-col items-center justify-center gap-2 md:my-10 lg:py-10 py-7 lg:px-20 px-10 bg-leaf-green rounded-xl text-lima shadow-xl'>
        ...
        <span className='lg:text-3xl'>VALOR LANZAMIENTO</span>
        ...
        <span className='text-xl'>hasta el <b>31/01/26</b></span>
      </div>
      <div className='flex flex-col items-center justify-center gap-4'>
        <span className='lg:text-2xl'>VALOR REGULAR</span>
        ...
        <span className='lg:text-lg text-center font-medium text-dark-green'>
          <b>Señá tu cupo con 350 USD</b> y pagá en cuotas
        </span>
      </div>
