  ...
  return (
    <div className='flex flex-col items-center justify-center bg-creamy text-dark-green pt-10 pb-20 px-10'>
      ...
      <div className="flex md:flex-row flex-col items-center justify-evenly py-10 md:gap-0 gap-4">
        <div className='md:w-1/4 w-3/5 overflow-hidden border-2 md:mb-0 mb-5'>
          <img className='object-cover' src="./ludmia.jpg" alt="foto ludmi" />
        </div>
        <div className='md:w-3/5 lg:text-lg md:text-md sm:text-sm flex w-full flex-col items-start justify-center'>
          <h4 className='lg:text-2xl text-xl font-semibold text-right place-self-center'>Ludmi Kondra, <span className='font-bold text-lg text-leaf-green'>Argentina</span></h4>
      ...
      <div className="flex md:flex-row flex-col items-center justify-evenly py-10 md:gap-0 gap-4">
        ...
        <div className='md:w-3/5 lg:text-lg md:text-md sm:text-sm flex w-full flex-col items-start justify-center'>
            <h4 className='lg:text-2xl text-xl font-semibold text-right place-self-center'>Beatriz Lozano, <span className='font-bold text-lg text-leaf-green'>Perú</span></h4>
